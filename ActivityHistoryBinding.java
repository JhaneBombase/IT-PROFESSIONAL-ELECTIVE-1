...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull LinearLayout rootView, @NonNull Button cancelButton,
      @NonNull Button deleteButton, @NonNull RecyclerView historyRecycler,
      @NonNull Button selectAllButton) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((LinearLayout) rootView, cancelButton, deleteButton,
          historyRecycler, selectAllButton);
    }
